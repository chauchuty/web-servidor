            ...
            <div class="modal-body m-2">
                <form action="./../gateway.php" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control form-control-sm" name="data_inicio" min="<?= date("Y-m-d\TH:i"); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label col-form-label-sm">Perc. A</label>
                        <div class="col-sm-10">
                            <input type="number" step="0.01" class="form-control form-control-sm" name="perc_team_a" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label col-form-label-sm">Perc. B</label>
                        <div class="col-sm-10">
                            <input type="number" step="0.01" class="form-control form-control-sm" name="perc_team_b" autocomplete="off">
                        </div>
                    </div>
